...
Route::get('/admin',[AdminLoginController::class,'adminShow']);
Route::post('/admin/add',[AdminLoginController::class,'add'])->name('manager.add');
Route::get('/manager',[AdminLoginController::class,'manageShow']);

Route::get('/admin/login',[ManagementController::class,'index'])->name('admin.index');
Route::post('/admin/login', [ManagementController::class, 'login'])->name('admin.login');
